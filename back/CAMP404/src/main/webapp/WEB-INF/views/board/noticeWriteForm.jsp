...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/noticeWriteForm-style.css">
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/board/notice.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/noticeWriteForm.js"></script>
